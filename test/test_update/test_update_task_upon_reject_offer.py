...
def test_update_task_upon_accept_one_offer(cursor, task_dummy, offer_dummy, person_task_dummy, person_offer_dummy):
...
def test_update_task_upon_reject_one_in_two_offer(cursor, task_dummy, offer_dummy, offer_dummy_2, person_task_dummy, person_offer_dummy, person_offer_dummy_2):
    insert_new_person(cursor, person_task_dummy)
    insert_new_person(cursor, person_offer_dummy)
